...
@pytest.fixture
def sample_model(sample_buses_df, sample_lines_df, sample_trafos_df, sample_gens_df, sample_loads_df):
...
class TestVisualizeNetwork:
    ...
    def test_visualize_network_hide_lines(self, sample_model):
        ...
        line_traces = [t for t in fig.data if hasattr(t, 'legendgroup') and t.legendgroup == 'lines']
    ...
    def test_visualize_network_hide_generators(self, sample_model):
        ...
        gen_traces = [t for t in fig.data if hasattr(t, 'legendgroup') and t.legendgroup == 'generators']
    ...
    def test_visualize_network_hide_loads(self, sample_model):
        ...
        load_traces = [t for t in fig.data if hasattr(t, 'legendgroup') and t.legendgroup == 'loads']
    ...
    def test_visualize_network_hide_transformers(self, sample_model):
        ...
        trafo_traces = [t for t in fig.data if hasattr(t, 'legendgroup') and t.legendgroup == 'transformers']
...
class TestAddBusesToFigure:
    ...
    def test_add_buses_hover_text(self, sample_buses_df):
        ...
        all_hover = " ".join(
            ...
            for ht in (trace.hovertext if isinstance(trace.hovertext, (list, tuple)) else [trace.hovertext])
        )
