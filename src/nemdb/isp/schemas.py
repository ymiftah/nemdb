...
class SummaryMapping(pa.DataFrameModel):
    rowid: pl.String = Field(nullable=True)
    iasr_id_dlt_names: pl.String = Field(nullable=True)
    power_station: pl.String = Field(nullable=True)
    technology_type: pl.String = Field(nullable=True)
    region: pl.String = Field(nullable=True)
    sub_region: pl.String = Field(nullable=True)
    ...
    status: pl.String = Field(nullable=True)
    regional_build_cost_zone: pl.String = Field(nullable=True)
    uptake: pl.String = Field(nullable=True)
    fuel_type: pl.String = Field(nullable=True)
    fuel_cost_mapping: pl.String = Field(nullable=True)
    maintenance_duration_pct: pl.String = Field(nullable=True)
    forced_outage_rate_full_outage_pct_of_time: pl.String = Field(nullable=True)
    forced_outage_rate_partial_outage_pct_of_time: pl.String = Field(nullable=True)
    mean_time_to_repair_full_outage: pl.String = Field(nullable=True)
    mean_time_to_repair_partial_outage: pl.String = Field(nullable=True)
    minimum_load_mw: pl.String = Field(nullable=True)
    maximum_capacity_factor_pct: pl.String = Field(nullable=True)
    fom_aud_kw_annum: pl.String = Field(nullable=True)
    vom_aud_mwh_sent_out: pl.String = Field(nullable=True)
    heat_rate: pl.String = Field(nullable=True)
    pumping_efficiency_pct: pl.String = Field(nullable=True)
    mlf: pl.String = Field(nullable=True)
    auxiliary_load_pct: pl.String = Field(nullable=True)
    connection_cost_technology: pl.String = Field(nullable=True)
    connection_cost_region: pl.String = Field(nullable=True)
    build_limit_technology: pl.String = Field(nullable=True)
    build_limit_region: pl.String = Field(nullable=True)
    total_lead_time: pl.String = Field(nullable=True)
